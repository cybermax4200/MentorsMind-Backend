...
export const AdminController = {
  ...
  async getStats(_req: AuthenticatedRequest, res: Response): Promise<void> {
    ...
    ResponseUtil.success(res, stats, 'Platform statistics retrieved successfully');
  },
  ...
  async listUsers(req: AuthenticatedRequest, res: Response): Promise<void> {
    ...
    ResponseUtil.success(res, result.data, 'Users retrieved successfully', 200, {
      total: result.total,
      limit,
      offset,
    } as any);
  ...
  async listTransactions(req: AuthenticatedRequest, res: Response): Promise<void> {
    ...
    ResponseUtil.success(res, result.data, 'Transactions retrieved successfully', 200, {
      total: result.total,
      limit,
      offset,
    } as any);
  ...
  async listDisputes(req: AuthenticatedRequest, res: Response): Promise<void> {
    ...
    ResponseUtil.success(res, result.data, 'Disputes retrieved successfully', 200, {
      total: result.total,
      limit,
      offset,
    } as any);
  ...
  async resolveDispute(req: AuthenticatedRequest, res: Response): Promise<void> {
    ...
    if (!['resolved', 'dismissed'].includes(status)) {
      ResponseUtil.error(res, 'Invalid status. Must be resolved or dismissed', 400);
      return;
    }
  ...
  async getSystemHealth(_req: AuthenticatedRequest, res: Response): Promise<void> {
  ...
  async getLogs(req: AuthenticatedRequest, res: Response): Promise<void> {
    ...
    ResponseUtil.success(res, result.data, 'System logs retrieved successfully', 200, {
      total: result.total,
      limit,
      offset,
    } as any);
